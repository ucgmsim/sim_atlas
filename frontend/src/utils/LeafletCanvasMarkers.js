/*
TODO: Create a React wrapper, using this straight isn't really a react-way
This is modified version of the expired/no longer maintained package
Also, tidy up methods/functions that are not used unless good reasons to keep it.
*/
...
function layerFactory(L) {
  var CanvasIconLayer = (L.Layer ? L.Layer : L.Class).extend({
    ...
    onAdd: function (map) {
      ...
      // To init the canvas on the right coordinates
    ...
    _initCanvas: function () {
      this._canvas = L.DomUtil.create("canvas", "leaflet-layer custom-layer");
    ...
    // Potential place to fix the overlayer issue
